# 10. Anti-patterns of the first months
...
**Why it hurts.** See chapter 9. A log is not memory. Stale notes push out useful ones, and nobody trusts the file anymore.
